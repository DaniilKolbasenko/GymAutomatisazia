...
INSERT OR IGNORE INTO members (id, full_name, phone, birth_date, join_date, trainer_id) VALUES
...
(14, 'Степанова Anna Алексеевна', '+7 (922) 555-66-77', '1998-09-11', date('now', '-5 days'), 5),
...
INSERT OR IGNORE INTO member_subscriptions (id, member_id, subscription_id, purchase_date, end_date, visits_left) VALUES
...
INSERT OR IGNORE INTO visits (id, member_id, visit_date) VALUES
(1, 1, date('now', '-1 hour')),
